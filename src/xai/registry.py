...
decorators below -- `xai.registrations` does this for the project's
...
--------------------------
    ...
    from xai.registry import register_simulator, SimulatorSpec
...
`register_xai_method` -- see `xai.registrations` for worked examples of
each.
"""
