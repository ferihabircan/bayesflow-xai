...
models in methods/integrated_gradients.py and methods/attention_rollout.py. Also
...
from bayesflow_xai.simulation.lotka_volterra.lotka_volterra_model import sample_fn as lv_sample_fn
from bayesflow_xai.utils.config import CONFIG, PARAM_NAMES
